  ...
  return (
    ...
    >
      <div className="container mx-auto px-6">
        ...
        <motion.p
          className="mt-4 text-lg text-center text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed"
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <div className="relative mt-16">
          ...
          <div className="space-y-16">
            ...
            >
              ...
              {/* Data */}
              <span className="absolute left-[calc(50%+0rem)] transform translate-x-full text-sm font-bold text-gray-800 dark:text-gray-400">
                2022
              </span>
            ...
            >
              ...
              {/* Data */}
              <span className="absolute left-[calc(50%-2rem)] transform -translate-x-full text-sm font-bold text-gray-800 dark:text-gray-400">
                2024
              </span>
